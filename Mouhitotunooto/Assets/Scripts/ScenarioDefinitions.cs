    ...
    public static class ScenarioDefinitions
    {
        ...
        private static Scenario CreateScenario1(int loopCount = 1)
        {
            ...
            else
            {
                ...
                scenario.branches[1] = new Branch
                {
                    text = $"私：「この人物は10年前に失踪した{MissingPersonNameManager.GetMissingPersonName()}様ですね」\n依頼人：「そう、でも私が知りたいのは・・・」\n私：「失礼しました。もうひとつの手がかりを調べます。背景の建物ですね」\n\n・・・",
                    hasWord = true,
        ...
        private static Scenario CreateScenario3(int loopCount = 1)
        {
            ...
            else
            {
                ...
                scenario.branches[2] = new Branch
                {
                    text = "友：「開けよう!」\n中には手紙が二通。\n私：「あれ、一通しか入れてないよね?」\n友：ニヤリと笑って「実は僕ももうひとつ入れてたんだ。読んでみて」\n手紙には励ましの言葉が綴られていた。\n",
                    hasWord = true,
        ...
        private static Scenario CreateScenario5(int loopCount = 1)
        {
            ...
            else
            {
                ...
                scenario.branches[2] = new Branch
                {
                    text = "床を這いつくばって探す。見つからない。\n恋人：「探し物?」\n私：「最後のピースが・・・」\n恋人：ポケットから取り出して「実はもうひとつ買っておいたんだ。君が完成させた時のために」\n箱には同じパズルが入っていた。\n",
                    hasWord = true,
        ...
        private static Scenario CreateScenario6(int loopCount = 1)
        {
            ...
            if (loopCount >= 3)
            {
                ...
                scenario.branches[1] = new Branch
                {
                    ...
                    hasWord = true,
                    epilogue = "もうひとつの真実を完全に理解したあなたは、これからも常に新しい可能性を探し続けることを誓いました。\n同時に、今あるものを大切にすることの重要性も深く理解しました。\n\n(あなたが集めた文字「も」「う」「ひ」「と」「つ」は、\nもうひとつという言葉として、あなたの心に永遠に刻まれました)"
                };
                scenario.branches[2] = new Branch
                {
            ...
            else if (loopCount >= 2)
            {
                ...
                scenario.branches[1] = new Branch
                {
                    ...
                    hasWord = true,
                    epilogue = "もうひとつの真実を知ったあなたは、これからも常に新しい可能性を探し続けることを誓いました。\nしかし、同時に、今あるものを大切にすることの重要性も学びました。\n\n(あなたが集めた文字「も」「う」「ひ」「と」「つ」は、\nもうひとつという言葉として、あなたの心に刻まれました)"
                };
                scenario.branches[2] = new Branch
                {
