    ...
    public static class ScenarioDefinitions
    {
        ...
        private static Scenario CreateScenario4(int loopCount = 1)
        {
            var scenario = new Scenario
            {
                id = 4,
                title = "魔法学校の試験",
                setup = loopCount >= 3 ? "試験官：「ウサギを出現させなさい」\nとおる試験官は、あなたを見て何かを感じ取ったような表情を浮かべています。\n「今回は、魔法と手品の両方を理解することが求められます」と、試験官が言いました。" 
                    : loopCount >= 2 ? "試験官：「ウサギを出現させなさい」\n今回は、手品の技術を試される試験のようです。" 
                    : "試験官：「ウサギを出現させなさい」",
                choices = loopCount >= 3 ? new List<Choice>
                {
                    new Choice { id = 1, text = "魔法と手品の両方を使ってウサギを出現させる", preview = "私：「魔法と手品を組み合わせて..." },
                    new Choice { id = 2, text = "試験官の言葉の意味を深く考える", preview = "私：「魔法と手品の両方を理解するというのは..." }
                } : loopCount >= 2 ? new List<Choice>
                {
                    new Choice { id = 1, text = "手品でウサギを2羽出現させる", preview = "パッ!ウサギが2..." },
                    new Choice { id = 2, text = "帽子から手品で取り出す", preview = "スッと帽子からウサ..." }
                } : new List<Choice>
                {
            ...
            if (loopCount >= 3)
            {
                ...
                scenario.branches[2] = new Branch
                {
                    ...
                    hint = "💡 ヒント: 魔法と手品の両方を使ってウサギを出現させることで、「もうひとつ」の真実に気づけるかもしれません。両方を組み合わせてみましょう。"
                };
            }
            else if (loopCount >= 2)
            {
